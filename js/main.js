...
//לאחר טעינת האתר נבדוק האם המכשיר תומך בהפעלת מצלמה
...
function doScreenshot() { 
    ...
    canvas.getContext('2d').drawImage(imageStickerLogo,-30,355,(imageStickerLogo.width*180/100),(imageStickerLogo.height*170/100));
